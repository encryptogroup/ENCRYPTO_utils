...
void PrintTimings() {
	...
	std::string unit = " ms";
	std::cout << "LOG: Timing Total: " << m_tTimes[P_TOTAL].timing << unit << std::endl;
	std::cout << "LOG: Timing Init: " << m_tTimes[P_INIT].timing << unit << std::endl;
	std::cout << "LOG: Timing CircuitGen: " << m_tTimes[P_CIRCUIT].timing << unit << std::endl;
	std::cout << "LOG: Timing Network: " << m_tTimes[P_NETWORK].timing << unit << std::endl;
	std::cout << "LOG: Timing BaseOTs: " << m_tTimes[P_BASE_OT].timing << unit << std::endl;
	std::cout << "LOG: Timing Setup: " << m_tTimes[P_SETUP].timing << unit << std::endl;
	std::cout << "LOG: Timing OTExtension: " << m_tTimes[P_OT_EXT].timing << unit << std::endl;
	std::cout << "LOG: Timing Garbling: " << m_tTimes[P_GARBLE].timing << unit << std::endl;
	std::cout << "LOG: Timing Online: " << m_tTimes[P_ONLINE].timing << unit << std::endl;
}
